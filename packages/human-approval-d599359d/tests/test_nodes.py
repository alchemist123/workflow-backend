"""Every node module in Human Approval, checked against its contract.
...
MODULE_NODES = ['a2a_start', 'n_condition_6', 'n_end_3', 'n_human_approval_4', 'n_transform_1', 'n_transform_2', 'n_transform_5']
