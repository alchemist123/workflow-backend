...
Jinja2: render a human-readable summary

Generated from canvas node 'format'. Do not edit by hand:
...
OUTPUT_VARIABLE = ""
ON_ERROR = "fail"
TEMPLATE = "{\"greeting\": \"Hello {{ name }}!\", \"email\": \"{{ email }}\", \"summary\": \"You have {{ item_count }} items totalling {{ total }}.\"}"
