...
Generated from canvas node 'settle'. Do not edit by hand:
...
@flow_node(name=NODE_ID, variable=OUTPUT_VARIABLE, **NODE_KWARGS(timeout=33))
async def n_wait_7(ctx: Context, node_input=None):
    data = node_input or {}
