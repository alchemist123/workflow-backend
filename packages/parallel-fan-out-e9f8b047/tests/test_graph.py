...
Generated for Parallel Fan-out. Runs offline: no model, no network.
"""

from __future__ import annotations

EXPECTED_NODES = ['a2a_start', 'n_end_3', 'n_merge_5', 'n_parallel_fork_4', 'n_transform_1', 'n_transform_2', 'n_transform_6', 'n_transform_7', 'n_transform_8']
# Nodes with a module of their own. A MERGE is a JoinNode built in the registry,
# so it has none.
MODULE_NODES = ['a2a_start', 'n_end_3', 'n_parallel_fork_4', 'n_transform_1', 'n_transform_2', 'n_transform_6', 'n_transform_7', 'n_transform_8']
