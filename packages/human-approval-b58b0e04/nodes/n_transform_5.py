"""TRANSFORM — Record Payment.

Generated from canvas node 'paid'. Do not edit by hand:
...
def _transform(data: dict) -> dict:
    ...
    result = None
    result = {'outcome': 'paid', 'cost_centre': data.get('cost_centre'), 'approved_by': 'finance'}
...
async def n_transform_5(ctx: Context, node_input=None):
    data = node_input or {}
    try:
