...
PAYLOAD_SCHEMA: dict = {'type': 'object', 'properties': {'sku': {'type': 'string', 'description': 'What was ordered'}, 'qty': {'type': 'integer', 'description': 'How many'}}, 'required': ['sku', 'qty']}

# An example payload, for the README and for a caller with no schema handling.
EXAMPLE_PAYLOAD: dict = {'sku': '', 'qty': 0}
