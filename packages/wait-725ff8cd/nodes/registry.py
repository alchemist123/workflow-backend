...
from nodes.n_wait_2 import n_wait_2
from nodes.n_wait_7 import n_wait_7
...
NODES: dict[str, Any] = {
    ...
    "n_merge_5": MergeNode(
        name="n_merge_5",
        merge_mode="merge",
        sources=['n_transform_1', 'n_transform_6'],
    ),
...
NODE_TITLES: dict[str, str] = {
    ...
    "n_end_3": "End",
    "n_merge_5": "Join",
    "n_parallel_fork_4": "Split",
    "n_transform_1": "Check Status",
    "n_transform_6": "Send Receipt",
    "n_wait_2": "Rate limit",
    "n_wait_7": "Let it settle",
}
