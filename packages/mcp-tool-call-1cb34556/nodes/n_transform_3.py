...
Generated from canvas node 'normalise'. Do not edit by hand:
...
OUTPUT_FIELDS: list[dict] = [{'name': 'code', 'source': 'data.item', 'type': 'string', 'required': True}, {'name': 'units', 'source': 'data.count', 'type': 'integer', 'required': True}]
