...
Send {score: number, message: string}
...
PAYLOAD_SCHEMA: dict = {'type': 'object', 'properties': {'score': {'type': 'integer', 'description': 'Score used for routing'}, 'message': {'type': 'string', 'description': 'Message echoed back'}}, 'required': ['score', 'message']}

# An example payload, for the README and for a caller with no schema handling.
EXAMPLE_PAYLOAD: dict = {'score': 0, 'message': ''}
