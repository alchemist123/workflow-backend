...
from nodes.n_condition_1 import n_condition_1
...
CANVAS_IDS: dict[str, str] = {
    "a2a_start": "trigger",
    "n_condition_1": "condition",
    "n_end_2": "end",
    "n_transform_3": "transform_high",
    "n_transform_4": "transform_low",
}
...
NODE_TITLES: dict[str, str] = {
    "a2a_start": "A2A Start",
    "n_condition_1": "Score Check",
    "n_end_2": "End",
    "n_transform_3": "Premium Response",
    "n_transform_4": "Standard Response",
}
