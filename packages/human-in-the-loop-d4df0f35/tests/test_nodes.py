"""Every node module in Human In The Loop, checked against its contract.
...
MODULE_NODES = ['a2a_start', 'n_condition_7', 'n_end_4', 'n_human_approval_5', 'n_human_input_3', 'n_transform_1', 'n_transform_2', 'n_transform_6']
