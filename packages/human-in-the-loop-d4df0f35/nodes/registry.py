...
from nodes.n_condition_7 import n_condition_7
from nodes.n_end_4 import n_end_4
from nodes.n_human_approval_5 import n_human_approval_5
from nodes.n_human_input_3 import n_human_input_3
...
NODES: dict[str, Any] = {
    "a2a_start": a2a_start,
    "n_condition_7": n_condition_7,
    "n_end_4": n_end_4,
    "n_human_approval_5": n_human_approval_5,
    "n_human_input_3": n_human_input_3,
...
CANVAS_IDS: dict[str, str] = {
    ...
    "n_condition_7": "size",
    "n_end_4": "end",
    "n_human_approval_5": "gate",
    "n_human_input_3": "details",
    "n_transform_1": "auto",
    "n_transform_2": "declined",
    "n_transform_6": "paid",
}
...
NODE_TYPES: dict[str, str] = {
    "a2a_start": "A2A_START",
    "n_condition_7": "CONDITION",
    "n_end_4": "END",
    "n_human_approval_5": "HUMAN_APPROVAL",
    "n_human_input_3": "HUMAN_INPUT",
...
NODE_TITLES: dict[str, str] = {
    ...
    "n_condition_7": "Needs approval?",
    "n_end_4": "End",
    "n_human_approval_5": "Finance Sign-off",
    "n_human_input_3": "Payment Details",
    "n_transform_1": "Auto-approve",
    "n_transform_2": "Record Decline",
    "n_transform_6": "Record Payment",
}
