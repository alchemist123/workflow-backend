...
OUTPUT_FIELDS: list[dict] = [{'name': 'description', 'source': 'data.sku', 'type': 'string', 'required': True}, {'name': 'quantity', 'source': 'data.quantity', 'type': 'integer', 'required': True}, {'name': 'amount', 'source': 'data.total', 'type': 'number', 'required': True}, {'name': 'currency', 'source': 'data.currency', 'type': 'string'}, {'name': 'ordered_as', 'source': 'vars.order.item', 'type': 'string'}]
