...
Generated for Data Transform Pipeline. Runs offline: no model, no network.
"""

from __future__ import annotations

EXPECTED_NODES = ['a2a_start', 'n_end_1', 'n_transform_2', 'n_transform_3']
# Nodes with a module of their own. A MERGE is a JoinNode built in the registry,
# so it has none.
MODULE_NODES = ['a2a_start', 'n_end_1', 'n_transform_2', 'n_transform_3']
