...
from nodes.n_orchestrator_agent_2 import n_orchestrator_agent_2

# ── The register ─────────────────────────────────────────────────────────────
NODES: dict[str, Any] = {
    "a2a_start": a2a_start,
    "n_end_1": n_end_1,
    "n_orchestrator_agent_2": n_orchestrator_agent_2,
}
...
CANVAS_IDS: dict[str, str] = {
    "a2a_start": "trigger",
    "n_end_1": "end",
    "n_orchestrator_agent_2": "orchestrator",
}
...
NODE_TYPES: dict[str, str] = {
    "a2a_start": "A2A_START",
    "n_end_1": "END",
    "n_orchestrator_agent_2": "ORCHESTRATOR_AGENT",
}
