...
PAYLOAD_SCHEMA: dict = {'type': 'object', 'properties': {'request': {'type': 'string', 'description': 'What the user wants planned or written', 'x-ui-widget': 'textarea'}}, 'required': ['request']}
