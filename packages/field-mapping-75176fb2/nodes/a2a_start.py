...
PAYLOAD_SCHEMA: dict = {'type': 'object', 'properties': {'sku': {'type': 'string', 'description': 'What was ordered'}, 'qty': {'type': 'integer', 'description': 'How many'}, 'gift_message': {'type': 'string', 'description': 'Optional note for the recipient'}}, 'required': ['sku', 'qty']}

# An example payload, for the README and for a caller with no schema handling.
EXAMPLE_PAYLOAD: dict = {'sku': '', 'qty': 0, 'gift_message': ''}
