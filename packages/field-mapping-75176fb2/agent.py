"""The workflow graph for Field Mapping.
...
Canvas node -> graph node:
    ...
    n_transform_3            TRANSFORM  (canvas 'shipment' — Shipment)
"""
...
# as a node name. The generator defaults it to "field_mapping".
root_agent = Workflow(
