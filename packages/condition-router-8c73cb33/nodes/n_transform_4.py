...
Standard response for low-score users

Generated from canvas node 'transform_low'. Do not edit by hand:
...
NODE_ID = "n_transform_4"
# Name this node saves its result under, for later nodes to read.
OUTPUT_VARIABLE = ""
ON_ERROR = "fail"
TEMPLATE = "{\"tier\": \"standard\", \"message\": \"{{ message }}\", \"score\": {{ score }}}"
...
async def n_transform_4(ctx: Context, node_input=None):
    data = node_input or {}
    try:
