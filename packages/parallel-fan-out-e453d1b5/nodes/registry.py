...
from nodes.n_end_3 import n_end_3
from nodes.n_parallel_fork_4 import n_parallel_fork_4
from nodes.n_transform_1 import n_transform_1
from nodes.n_transform_2 import n_transform_2
from nodes.n_transform_6 import n_transform_6
from nodes.n_transform_7 import n_transform_7
from nodes.n_transform_8 import n_transform_8
...
NODES: dict[str, Any] = {
    ...
    "n_merge_5": MergeNode(
        name="n_merge_5",
        merge_mode="merge",
        sources=['n_transform_1', 'n_transform_2', 'n_transform_6', 'n_transform_7'],
    ),
    "n_parallel_fork_4": n_parallel_fork_4,
    "n_transform_1": n_transform_1,
    "n_transform_2": n_transform_2,
    "n_transform_6": n_transform_6,
    "n_transform_7": n_transform_7,
    "n_transform_8": n_transform_8,
}
...
CANVAS_IDS: dict[str, str] = {
    ...
    "n_end_3": "done",
    "n_merge_5": "join",
    "n_parallel_fork_4": "fork",
    "n_transform_1": "audit",
    "n_transform_2": "discount",
    "n_transform_6": "shipping",
    "n_transform_7": "tax",
    "n_transform_8": "total",
}
...
NODE_TYPES: dict[str, str] = {
    ...
    "n_transform_2": "TRANSFORM",
    "n_transform_6": "TRANSFORM",
    "n_transform_7": "TRANSFORM",
    "n_transform_8": "TRANSFORM",
}
...
NODE_TITLES: dict[str, str] = {
    ...
    "n_end_3": "Done",
    "n_merge_5": "Join",
    "n_parallel_fork_4": "Fan Out",
    "n_transform_1": "Audit",
    "n_transform_2": "Discount",
    "n_transform_6": "Shipping",
    "n_transform_7": "Tax",
    "n_transform_8": "Grand Total",
}
